...
// 相棒の解析データ（住所）
#define ADDR_VIEW_MATRIX 0x03A3AC78  // Matrixの住所
#define OFF_PLAYER_STATE 0x50        // PlayerStateのオフセット
#define OFF_COORD_XYZ    0x1A0       // 座標(XYZ)の場所（一般的数値）
...
- (void)drawRect:(CGRect)rect {
    // ここに相棒が見つけたMatrixと座標を使って「箱」を書く処理が入るじょ！
    // 今回は動作確認用に赤い点だけ打つ設定だニダ
